        ...
        <div class="page-content">
            <div class="card">
                <div class="card-body">
                                ...
                                <select class="form-select single-select-clear-field" name="college_name" id="college_name"
                                   ...
                                   <option value="All" {{ old('college_name', request('college_name')) == 'All' ? 'selected' : '' }}>All</option>
                                    @foreach($mapped_college_to_staff1 as $key => $value)
                                        <option value="{{$value}}" {{ old('college_name', request('college_name')) == $key ? 'selected' : '' }}>
                    ...
                    <div class="col-md-12 d-none" id="smsCardSection">
                            <div class="card">
                        ...
                        <div class="col-md-12 d-none" id="mailCardSection">
                            <div class="card">
                                <div class="card-header">
                                    <h5>
