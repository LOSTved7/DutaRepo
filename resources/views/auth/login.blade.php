...
// dd($_SERVER['HTTP_HOST']);
	...
	$show_signup_option = empty($college_data->show_signup_option)?false:true;//0 means false , 1 means true
	// dd($show_signup_option);

	if($host == 'localhost'|| $host=='127') {
		$college_id = NULL;	//33 stands for LakshmiBai College, 44 for Ramanujan College
	}
	if($host=='college') {
		...
		elseif($host == 'unione') {
			$college_id = NULL;	//NULL for companies
		}
	}
	// dd($college_data);
