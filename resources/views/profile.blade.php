									...
									<div class="card-body">
										...
										<ul class="list-group list-group-flush">
											...
											<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
												...
												<span class="text-secondary">{{$user_arr['designation']}}</span>
											</li>
											@elseif(Auth::user()->role_id==34)
											<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
												<h6 class="mb-0">Designation</h6>
												<span class="text-secondary">Principal's Office</span>
											</li>
											@else
											<li class="list-group-item d-flex justify-content-between align-items-center flex-wrap">
												<h6 class="mb-0">Designation</h6>
							...
							<div class="col-lg-8">
								...
								{{--<a class="btn btn-primary ms-2 mt-2 " style="width:250px;height:40px;"  target="_blank" href="https://www.antiragging.in/affidavit_affiliated_form.php">AntiRaging Form</a>--}}
									...
									<div class="card-body">
										...
										<div class="row mb-3">
											<div class="col-sm-3">
												<h6 class="mb-0">CSAS/Enrollment Number</h6>
											</div>
											<div class="col-sm-9 text-secondary">
