				...
				<div class="card-body">
					<div class="p-3">
						...
						<p class="text-muted" id="supporting_text">OTP has been sent on your registered email id.</p>
							...
							<input type="hidden" name="users_id" value="{{$users_id}}" id="usersId">
...
<script type="text/javascript">
	...
	function submit_form() {
		...
		var users_id = document.getElementById('usersId').value;
			        ...
			        if(data.code == 401) { }
			            ...
			            if(data.alert_message == undefined) {
			            	if(data.token==undefined) {
			            		 Swal.fire({
				                    title: 'Success!',
				                    text: data.message ?? 'User Created Successfully. Please login to continue.',
				                    icon: 'success',
